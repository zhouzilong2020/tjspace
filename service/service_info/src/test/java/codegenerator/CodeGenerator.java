...
public class CodeGenerator {
    ...
    public void run() {
        ...
        gc.setOutputDir(projectPath + "/src/main/java/new");    // 输出目录
        ...
        pc.setModuleName("infoservice");     //模块名
        // com.tjspace.infoservice.controller/entity...
...
//        info :: ("info_course", "info_major", "info_section", "info_teacher", "info_user");
        strategy.setInclude("info_course", "info_dept", "info_teaches", "info_teacher", "info_user"); // 表的名称，逆向生成！
